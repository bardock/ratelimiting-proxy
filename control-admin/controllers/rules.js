...
router.delete('/:id', utils_1.default.handler((req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    const result = yield ka.deleteApplication({
        ApplicationName: appName,
        CreateTimestamp: appDesc.ApplicationDetail.CreateTimestamp
    }).promise();
    res.json("OK");
})));
router.put('/:id/start', utils_1.default.handler((req, res) => __awaiter(this, void 0, void 0, function* () {
    const appName = getAppName(req.params.id);
    yield start(appName);
    res.json(yield find(appName));
})));
router.put('/:id/stop', utils_1.default.handler((req, res) => __awaiter(this, void 0, void 0, function* () {
    const appName = getAppName(req.params.id);
    yield ka.stopApplication({ ApplicationName: appName }).promise();
    res.json(yield find(appName));
})));
...
function start(appName) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield ka.startApplication({
            ApplicationName: appName,
            InputConfigurations: [{
                    Id: "1.1",
